...
/// MENU BAR INIT ///
	...
	connect(ui->actionSin, SIGNAL(triggered(bool)),
		this, SLOT(sinClicked()));	
	connect(ui->actionCos, SIGNAL(triggered(bool)),
		this, SLOT(cosClicked()));	
	connect(ui->actionTan, SIGNAL(triggered(bool)),
		this, SLOT(tanClicked()));	
	connect(ui->actionCot, SIGNAL(triggered(bool)),
		this, SLOT(cotClicked()));	
	connect(ui->actionSec, SIGNAL(triggered(bool)),
		this, SLOT(secClicked()));	
	connect(ui->actionCsc, SIGNAL(triggered(bool)),
		this, SLOT(cscClicked()));

	connect(ui->actionArcsin, SIGNAL(triggered(bool)),
		this, SLOT(arcsinClicked()));	
	connect(ui->actionArccos, SIGNAL(triggered(bool)),
		this, SLOT(arccosClicked()));	
	connect(ui->actionArctan, SIGNAL(triggered(bool)),
		this, SLOT(arctanClicked()));	
	connect(ui->actionArccot, SIGNAL(triggered(bool)),
		this, SLOT(arccotClicked()));	
	connect(ui->actionArcsec, SIGNAL(triggered(bool)),
		this, SLOT(arcsecClicked()));	
